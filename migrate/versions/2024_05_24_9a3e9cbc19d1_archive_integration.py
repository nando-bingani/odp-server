...
Revision ID: 9a3e9cbc19d1
Revises: df57d06e1ee5
Create Date: 2024-05-24 10:52:17.845536
...
def upgrade():
    ...
    op.create_table('package_audit',
                    ...
                    sa.Column('_resources', sa.ARRAY(sa.String()), nullable=True),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.add_column('record_audit', sa.Column('_packages', sa.ARRAY(sa.String()), nullable=True))
